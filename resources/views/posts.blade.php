...
<h1 class="mb-3 text-dark text-center" style="font-weight: 700; overflow-y:hidden">{{ $title }}</h1>
...
<div class="card">
 <div class="card mb-3">
    <img src="http://source.unsplash.com/500x400?{{ $posts[0]->category->name }}" class="rounded">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="/posts/{{ $post->slug }}" class="btn dtl-1 dtl-2 py-2"> Detail <i class="bi bi-arrow-right"></i></a>
