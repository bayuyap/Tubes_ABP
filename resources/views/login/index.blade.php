    ...
    <div class="col-md-4 logy">
        ...
        <main class="form-signin">
            <form action="/login" method="post">
                @csrf
                <center>
              <h1 class="text-light"><b>Let's Vacation Together</b></h1>
            </center>
              ...
              <button class="w-100 btn btn-lg btn-outline-primary btn-transparent text-light shadow-lg mt-3" type="submit">Login</button>
            </form>
