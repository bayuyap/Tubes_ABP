    ...
    <div class="col-md-4 reg">
        <main class="form-registration ms-auto">
            <form action="/register" method="post">
                @csrf
                <center>
             <h1><b class="text-light">Let's Vacation Together</b></h1>
            </center>
              ...
              <div class="form-floating shadow-lg mt-2">
                ...
                @endif
                <button class="w-100 btn btn-lg btn-outline-primary btn-transparent text-light shadow-lg mt-3" type="submit">Submit</button>
              </div>
            </form>
